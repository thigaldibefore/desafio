    ...
    var supports = !!document.querySelector && !!root.addEventListener, // feature test
        ...
        */
        extendObj = function () {
            ...
            var _ = this, _args = arguments, titleType = typeof _args[0], msgType = typeof _args[1],
                tType = typeof _args[2];
                        ...
                        if (e.target.matches('.dlg-search')) {
                            ...
                            for (var i = 0; i < _items.length; i++) {
                                var dlgItem = _items[i],
                                    ...
                                    item = _.cache[input.id], iType = typeof item,
